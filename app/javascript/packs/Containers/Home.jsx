...
export default class Home extends Optimized {
  ...
  render () {
    ...
    return <Flex wide stretch2 column>
      <Banner videos={homeVideos} body='“...em meio à desintegração, está tomando forma um novo modo de vida coletiva que dá expressão prática a tudo que é divino nos seres humanos.”'/>
